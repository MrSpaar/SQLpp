...
#define GROUP_CONCAT_1(x)          sqlpp::expr::MathExpr<std::any, std::string>("GROUP_CONCAT", x)
#define GROUP_CONCAT_2(x, y)       sqlpp::expr::MathExpr<std::any, std::string>("GROUP_CONCAT", x, y)
#define STRING_AGG(x,y)            sqlpp::expr::MathExpr<std::any, std::string>("STRING_AGG", x, y)
...
#define GROUP_CONCAT(...)          CHOOSE_2(__VA_ARGS__, GROUP_CONCAT_2, GROUP_CONCAT_1)(__VA_ARGS__)
...
#define DATE(...)                  sqlpp::expr::MathExpr<std::any, std::string>("DATE", ##__VA_ARGS__)
#define TIME(...)                  sqlpp::expr::MathExpr<std::any, std::string>("TIME", ##__VA_ARGS__)
#define DATETIME(...)              sqlpp::expr::MathExpr<std::any, std::string>("DATETIME", ##__VA_ARGS__)
#define JULIANDAY(...)             sqlpp::expr::MathExpr<std::any, std::string>("JULIANDAY", ##__VA_ARGS__)
#define UNIXEPOCH(...)             sqlpp::expr::MathExpr<std::any, std::string>("UNIXEPOCH", ##__VA_ARGS__)
#define STRFTIME(format, ...)      sqlpp::expr::MathExpr<std::any, std::string>("STRFTIME", format, ##__VA_ARGS__)
#define TIMEDIFF(x, y)             sqlpp::expr::MathExpr<std::any, std::string>("TIMEDIFF", x, y)
...
#define TOTAL(x)                   sqlpp::expr::MathExpr<int, int>("TOTAL", x)
